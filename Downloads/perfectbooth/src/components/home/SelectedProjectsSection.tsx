    ...
    >
      <div className="portfolio-container">
        ...
        <div className="portfolio-footer-cta">
          <Link href="/projects" className="pb-btn-premium">
            <span>{t('viewAll')}</span>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="btn-arrow" style={{ transform: dir === 'rtl' ? 'scaleX(-1)' : 'none' }}>
